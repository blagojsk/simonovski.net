        ...
        const skills = [
            {
                ...
                items: 'Java, Spring & Spring Boot, REST, Hibernate, Liquibase, JUnit, Mockito, Arch Unit, ActiveMQ, RabbitMQ, Kafka, Hazelcast, Eureka, Zuul, Hystrix, JWT, JSON, OpenID, SAML, Nginx, WordPress, cPanel'
            },
            {
